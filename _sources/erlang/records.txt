...
These records are defined inside `include/xapian.hrl` and can be included,
...
Here is the C++ and Erlang versions of the same code.
...
operator `=:=`. 
That is why, 
``#x_prefix_name{name="author"}`` and ``#x_prefix_name{name=author}``
...
+----------+-------------------+---------------------+
| Name     | Stemmer           | Prefixes            |
+==========+===================+=====================+
| default  | from open params  | from open params    |
+----------+-------------------+---------------------+
| standard | not defined       | not defined         |
+----------+-------------------+---------------------+
